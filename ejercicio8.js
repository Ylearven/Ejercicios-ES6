...
const encontrar = videogames.filter((videogame) =>
  videogame.genders.includes('RPG')
)
const sumas = videogames.reduce((suma, videogame) => suma + videogame.score, 0)
const puntuacionmedia = sumas / encontrar.length
console.log(
  'La media de la puntuacion de los video juegos RPG es de:',
  puntuacionmedia
)
